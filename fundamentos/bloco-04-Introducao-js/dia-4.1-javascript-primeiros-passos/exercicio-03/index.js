...
if(nota >= 80){
    console.log('Parabéns você foi aprovado em nosso processo seletivo.');
}else if(nota <= 80 && nota >= 60) {
    console.log('Informamos que você foi selecionada para a lista de espera.');
}else {
    console.log('Infelismente você não conseguiu ir adiante em nosso processo seletivo, continue tentando. Boa Sorte!');
};