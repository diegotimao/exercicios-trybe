...
// O array deve ser ordenado por idade, ou seja, da pessoa mais jovem para a mais velha considerando suas 
// idades quando o livro foi lançado.

const newArrayBook = books.map((book) => {
...
const genero = () => {
  const generoItem = books.filter((item) => item.genre === 'Ficção Científica');
...
// const resultBook = books.filter((book) =>{ 
//   return  new Date().getFullYear() - book.releaseYear >= 60;
// })
